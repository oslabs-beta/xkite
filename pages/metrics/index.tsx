...
import type { KiteState } from 'xkite-core';
import {
  Grid,
  Tab,
  Tabs,
...
function DashboardTasks() {
  ...
  const checkActive = async () => {
    try {
      ...
      const data = (await response.text()) as KiteState;
      if (data === 'Running') {
        setConnected(0);
      } else {
        setConnected(1);
  ...
  return (
    <>
      ...
      <PageTitleWrapper>{connected === 1 && pageMessage()}</PageTitleWrapper>
                    ...
                    <Grid container spacing={3}>
                      <Grid item xs={3}>
                        <div>
                          ...
                          <iframe
                            src={`http://localhost:${grafanaPort}/d/5nhADrDWk/kafka-metrics?orgId=1&refresh=5s&viewPanel=647&kiosk`}
                          ></iframe>
                        </div>
                      </Grid>
                      <Grid item xs={3}>
                        <div>
                          ...
                          <iframe
                            src={`http://localhost:${grafanaPort}/d/5nhADrDWk/kafka-metrics?orgId=1&refresh=5s&viewPanel=233&kiosk`}
                          ></iframe>
                        </div>
                      </Grid>
                      <Grid item xs={3}>
                      ...
                      <Grid item xs={3}>
                        <div>
                          ...
                          <iframe
                            src={`http://localhost:${grafanaPort}/d/5nhADrDWk/kafka-metrics?orgId=1&refresh=5s&viewPanel=40&kiosk`}
                          ></iframe>
                        </div>
                      </Grid>
                    </Grid>
                    ...
                    >
                      <Grid item xs={6}>
                        <ListItem>
                          <div>
                            <h3 className="metric-header">
                              Failed Produce Requests Per Broker
                            </h3>
                            <iframe
                      ...
                      <Grid item xs={6}>
                        <ListItem>
                          <div>
                            <h3 className="metric-header">
                              Failed Produce Requests Per Topic
                            </h3>
                            <iframe
                      ...
                      <Grid item xs={6}>
                        <ListItem>
                          <div>
                            <h3 className="metric-header">
                              Failed Fetch Requests Per Broker
                            </h3>
                            <iframe
                      ...
                      <Grid item xs={6}>
                        <ListItem>
                          <div>
                            <h3 className="metric-header">
                              Failed Fetch Requests Per Topic
                            </h3>
                            <iframe
                    ...
                    >
                      ...
                      <Grid item xs={6}>
                        <ListItem>
                          <div>
                            <h3 className="metric-header">
                              Fetch Consumer Latency Per Broker
                            </h3>
                            <iframe
                      ...
                      <Grid item xs={6}>
                        <ListItem>
                          <div>
                            <h3 className="metric-header">
                              Fetch Consumer Requests Per Broker
                            </h3>
                            <iframe
                      ...
                      <Grid item xs={6}>
                        <ListItem>
                          <div>
                            <h3 className="metric-header">
                              Total Fetch Requests Per Broker
                            </h3>
                            <iframe
                    ...
                    >
                      ...
                      <Grid item xs={6}>
                        <ListItem>
                          <div>
                            <h3 className="metric-header">
                              Total Produce Request Rate Per Topic
                            </h3>
                            <iframe
                    ...
                    >
                      ...
                      <Grid item xs={6}>
                        <ListItem>
                          <div>
                            <h3 className="metric-header">
                              Partitions Leader and Replica Per Broker
                            </h3>
                            <iframe
                      ...
                      <Grid item xs={6}>
                        <ListItem>
                          <div>
                            <h3 className="metric-header">
                              Count of Partitions Per Broker
                            </h3>
                            <iframe
